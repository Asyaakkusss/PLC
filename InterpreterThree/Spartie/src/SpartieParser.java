...
public class SpartieParser {
    ...
    private Statement forStatement() {
        ...
        if (increment != null) {
            ...
            if (body instanceof Statement.BlockStatement blockStmt) {
                bodyStatements.addAll(blockStmt.statements);
            } else {
                bodyStatements.add(body);
            }

            bodyStatements.add(new Statement.ExpressionStatement(increment));
            body = new Statement.BlockStatement(bodyStatements);
        }
